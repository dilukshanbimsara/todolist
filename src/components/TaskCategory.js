          ...
          {get
            ?.filter((item) => {
              return todo.toLowerCase() === ""
                ? item
                : item.title.toLowerCase().includes(todo) || item.due_date.includes(todo) || item.description.toLowerCase().includes(todo);
            })
            .map((item, index) => (
              <>
                {item.status === "todo" ? (
          ...
          {get
            ?.filter((item) => {
              return progress.toLowerCase() === ""
                ? item
                : item.title.toLowerCase().includes(progress) || item.due_date.includes(progress) || item.description.toLowerCase().includes(progress);
            })
            .map((item, index) => (
              <>
          ...
          {get
            ?.filter((item) => {
              return done.toLowerCase() === ""
                ? item
                : item.title.toLowerCase().includes(done) || item.due_date.includes(done) || item.description.toLowerCase().includes(done);
            })
            .map((item, index) => (
              <>
                {item.status === "done" ? (
